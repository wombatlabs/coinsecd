...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One coinsec is a quantity of sompi as defined by the
	// sompiPerCoinsec constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Coinsec, but perhaps possible if an alt increases
