/*
Package txscript implements the coinsec transaction script language.

This package provides data structures and functions to parse and execute
coinsec transaction scripts.

# Script Overview

Coinsec transaction scripts are written in a stack-base, FORTH-like language.

The coinsec script language consists of a number of opcodes which fall into
...
Typical coinsec scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend coinsec.
