...
func (x *CoinsecdMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CoinsecdMessage_Version is nil")
	}
...
func (x *CoinsecdMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
