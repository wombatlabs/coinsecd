...
func (x *CoinsecdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "CoinsecdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *CoinsecdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
