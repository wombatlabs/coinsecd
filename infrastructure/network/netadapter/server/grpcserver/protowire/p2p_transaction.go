...
func (x *CoinsecdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CoinsecdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *CoinsecdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
