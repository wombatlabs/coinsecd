...
func (x *CoinsecdMessage_RequestAddresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CoinsecdMessage_RequestAddresses is nil")
	}
...
func (x *RequestAddressesMessage) toAppMessage() (appmessage.Message, error) {
	...
	//  Full coinsec nodes set SubnetworkId==nil
...
func (x *CoinsecdMessage_RequestAddresses) fromAppMessage(msgGetAddresses *appmessage.MsgRequestAddresses) error {
