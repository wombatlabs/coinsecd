...
type GetBlockTemplateRequestMessage struct {
	...
	// Which coinsec address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether coinsecd thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when coinsecd is not synced.
	// That is because when coinsecd isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this coinsecd initiated the connection
	...
	// The timestamp of when this peer connected to this coinsecd
