...
func (x *CoinsecdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "CoinsecdMessage_Addresses is nil")
	}
...
func (x *CoinsecdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
