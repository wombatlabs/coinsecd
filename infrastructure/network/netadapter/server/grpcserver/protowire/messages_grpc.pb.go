...
type P2P_MessageStreamClient interface {
	Send(*CoinsecdMessage) error
	Recv() (*CoinsecdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *CoinsecdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*CoinsecdMessage, error) {
	m := new(CoinsecdMessage)
...
func (x *p2PMessageStreamServer) Send(m *CoinsecdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*CoinsecdMessage, error) {
	m := new(CoinsecdMessage)
...
func (x *rPCMessageStreamClient) Send(m *CoinsecdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*CoinsecdMessage, error) {
	m := new(CoinsecdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *CoinsecdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*CoinsecdMessage, error) {
	m := new(CoinsecdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
