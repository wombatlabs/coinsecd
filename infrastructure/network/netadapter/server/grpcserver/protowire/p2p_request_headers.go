...
func (x *CoinsecdMessage_RequestHeaders) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *CoinsecdMessage_RequestHeaders) fromAppMessage(msgRequestHeaders *appmessage.MsgRequestHeaders) error {
