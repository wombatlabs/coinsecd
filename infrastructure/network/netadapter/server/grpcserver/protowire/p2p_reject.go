...
func (x *CoinsecdMessage_Reject) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CoinsecdMessage_Reject is nil")
	}
...
func (x *CoinsecdMessage_Reject) fromAppMessage(msgReject *appmessage.MsgReject) error {
