...
func (x *CoinsecdMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "CoinsecdMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *CoinsecdMessage_RequestPruningPointUTXOSet) fromAppMessage(
