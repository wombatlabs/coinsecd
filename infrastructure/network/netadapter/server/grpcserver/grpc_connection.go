...
type grpcStream interface {
	Send(*protowire.CoinsecdMessage) error
	Recv() (*protowire.CoinsecdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.CoinsecdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.CoinsecdMessage) error {
