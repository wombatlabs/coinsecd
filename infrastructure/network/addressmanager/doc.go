/*
Package addressmanager implements concurrency safe Coinsec address manager.

# Address Manager Overview

In order maintain the peer-to-peer Coinsec network, there needs to be a source
of addresses to connect to as nodes come and go. The Coinsec protocol provides
