...
// installService attempts to install the coinsecd service. Typically this should
...
// removeService attempts to uninstall the coinsecd service. Typically this should
...
// startService attempts to Start the coinsecd service.
