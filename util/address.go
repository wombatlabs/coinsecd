...
const (
	...
	Bech32PrefixCoinsecDev

	// Prefix for the test network.
	Bech32PrefixCoinsecTest

	// Prefix for the simulation network.
	Bech32PrefixCoinsecSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"coinsec":     Bech32PrefixCoinsec,
	"coinsecdev":  Bech32PrefixCoinsecDev,
	"coinsectest": Bech32PrefixCoinsecTest,
	"coinsecsim":  Bech32PrefixCoinsecSim,
}
...
// and a payload which encodes the coinsec network and address type. It is used
...
// with the passed coinsec network.
