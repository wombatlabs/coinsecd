...
// MsgRequestAnticone implements the Message interface and represents a coinsec
...
// NewMsgRequestAnticone returns a new coinsec RequestPastDiff message that conforms to the
