...
// MsgIBDChainBlockLocator implements the Message interface and represents a coinsec
...
// NewMsgIBDChainBlockLocator returns a new coinsec locator message that conforms to
