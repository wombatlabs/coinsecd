...
// coinsec Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a coinsec
// Addresses message.
...
// NewMsgAddresses returns a new coinsec Addresses message that conforms to the
