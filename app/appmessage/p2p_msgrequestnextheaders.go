...
// MsgRequestNextHeaders implements the Message interface and represents a coinsec
...
// NewMsgRequestNextHeaders returns a new coinsec RequestNextHeaders message that conforms to the
// Message interface.
