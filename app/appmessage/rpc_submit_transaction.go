...
// RPCTransaction is a coinsecd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a coinsecd transaction input representation
...
// RPCScriptPublicKey is a coinsecd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a coinsecd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a coinsecd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a coinsecd utxo entry representation meant to be used
// over RPC
