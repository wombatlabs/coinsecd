...
// MsgRequestAddresses implements the Message interface and represents a coinsec
...
// NewMsgRequestAddresses returns a new coinsec RequestAddresses message that conforms to the
