...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a coinsec
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new coinsec RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
