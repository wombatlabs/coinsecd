...
// MsgDoneHeaders implements the Message interface and represents a coinsec
...
// NewMsgDoneHeaders returns a new coinsec DoneIBDBlocks message that conforms to the
// Message interface.
