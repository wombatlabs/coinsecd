...
// MsgRequestRelayBlocks implements the Message interface and represents a coinsec
...
// NewMsgRequestRelayBlocks returns a new coinsec RequestRelayBlocks message that conforms to
