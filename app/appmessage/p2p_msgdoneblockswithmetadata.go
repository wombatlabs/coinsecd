...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a coinsec
...
// NewMsgDoneBlocksWithTrustedData returns a new coinsec DoneBlocksWithTrustedData message that conforms to the
// Message interface.
