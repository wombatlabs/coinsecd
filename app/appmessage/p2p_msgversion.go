...
var DefaultUserAgent = fmt.Sprintf("/coinsecd:%s/", version.Version())

// MsgVersion implements the Message interface and represents a coinsec version
...
// NewMsgVersion returns a new coinsec version message that conforms to the
