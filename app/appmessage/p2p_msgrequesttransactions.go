...
// MsgRequestTransactions implements the Message interface and represents a coinsec
...
// NewMsgRequestTransactions returns a new coinsec RequestTransactions message that conforms to
