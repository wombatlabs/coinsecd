...
// Start launches all the coinsecd services.
...
// Stop gracefully shuts down all the coinsecd services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Coinsecd is already in the process of shutting down")
		return
	}

	log.Warnf("Coinsecd shutting down")
