...
// By having at least 0.2SEC in the change output we make sure that every transaction with send value >= 0.2SEC
...
const minChangeTarget = constants.SompiPerCoinsec / 5
