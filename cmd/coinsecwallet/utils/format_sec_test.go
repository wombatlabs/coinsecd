...
func TestSecToSompi(t *testing.T) {
	...
	validCases := []testVector{
		...
		{originalAmount: "1", convertedAmount: 1000000000},
		{originalAmount: "33184.1489732", convertedAmount: 33184148973200},
		{originalAmount: "21.358080321", convertedAmount: 21358080321},
		{originalAmount: "18446744073.709551615", convertedAmount: 18446744073709551615},
	}
	...
	invalidCases := []string{
		"18446744073.709551616", // Bigger than max uint64
		"-1",
		"a",
		"",
	}
